...
import (
	...
	"github.com/AustinMusiku/Greenlight/internal/jsonlog"
	"github.com/AustinMusiku/Greenlight/internal/mailer"
	_ "github.com/lib/pq"
)
...
func main() {
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.austinmusiku.net>", "SMTP sender")
